...
ENTITY framebuffer IS
	...
	(
		...
		data		: IN STD_LOGIC_VECTOR (0 DOWNTO 0); -- color to write to memory (1 or 0)
		rdaddress		: IN STD_LOGIC_VECTOR (18 DOWNTO 0); -- address to read from 
		wraddress		: IN STD_LOGIC_VECTOR (18 DOWNTO 0); -- address to write to
		wren		: IN STD_LOGIC  := '0'; -- write enable
		q		: OUT STD_LOGIC_VECTOR (0 DOWNTO 0) -- color to draw to VGA
	);
END framebuffer;
